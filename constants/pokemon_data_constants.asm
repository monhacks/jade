...
; evolution types (used in data/pokemon/evos_attacks.asm)
	...
	const EVOLVE_LEVEL_RAND1
	const EVOLVE_LEVEL_RAND2
	const EVOLVE_LEVEL_FEMALE

	const EVOLVE_LEVEL_ITEM
	const EVOLVE_LEVEL_MOVE
	const EVOLVE_LEVEL_ITEM_NITE

	const EVOLVE_LEVEL_WITH_DARK
	const EVOLVE_LEVEL_ABILITY

	const EVOLVE_LANDMARK
	const EVOLVE_ITEM_NITE
	const EVOLVE_ITEM_BLOODMOON
...
DEF GRASS_WILDDATA_LENGTH EQU 2 + (1 + NUM_GRASSMON * 3) * 1
